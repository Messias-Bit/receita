...
scriptCode += `GuiControl, 1:, StartButton, +Disabled\n`;
scriptCode += `GuiControl, 1:, PauseButton, -Disabled\n`;
...
scriptCode += `return\n\n`;
        ...
        scriptCode += `    return\n`;
        scriptCode += `}\n`;
        scriptCode += `if (textIndex > ${processedLines.length}) {\n`;
        scriptCode += `    SetTimer, SendNextText, Off\n`;
        scriptCode += `    GuiControl, 1:, StartButton, -Disabled\n`;
        scriptCode += `    GuiControl, 1:, PauseButton, +Disabled\n`;
