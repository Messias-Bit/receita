...
scriptCode += `        speedText.Value := "Intervalo: " value ".0 segundos"\n`;
scriptCode += `    })\n\n`;

scriptCode += `    startBtn := MainGui.AddButton("x40 y170 w90 h30 -E0x200", "Iniciar")\n`;
...
scriptCode += `    pauseBtn := MainGui.AddButton("x145 y170 w90 h30 -E0x200 Disabled", "Pausar")\n`;
...
scriptCode += `    reloadBtn := MainGui.AddButton("x250 y170 w90 h30 -E0x200", "Recarregar")\n`;
...
scriptCode += `    yesBtn := QuestionGui.AddButton("x20 y60 w80 h30 -E0x200", "Sim")\n`;
...
scriptCode += `    noBtn := QuestionGui.AddButton("x110 y60 w80 h30 -E0x200", "Não")\n`;
...
scriptCode += `    nickEdit := ConfigGui.AddEdit("x20 y100 w300 h35 -E0x200")\n`;
scriptCode += `    nickEdit.Opt("+Background" Theme.Background " c" Theme.Text)\n\n`;

scriptCode += `    confirmBtn := ConfigGui.AddButton("x95 y150 w150 h40 -E0x200", "Confirmar")\n`;
...
scriptCode += `    okBtn := WarningGui.AddButton("x145 y170 w110 h35 -E0x200", "Entendi")\n`;
...
scriptCode += `    ConfigGui.Submit(false)\n`;
scriptCode += `    newNick := ConfigGui["NickEdit"].Value\n`;
...
scriptCode += `    MainGui["StatusText"].Value := message\n`;
scriptCode += `    SetTimer(() => MainGui["StatusText"].Value := "", -4000)\n`;
scriptCode += `}\n\n`;
